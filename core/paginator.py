...
class Paginator(disnake.ui.View):
    ...
    async def start(
        ...
        self.next_button.disabled = self.previous_button.disabled = True
        self.trash_button.disabled = False
        ...
        if self.total_page_count > 0:
            print("?")
            self.next_button.disabled = self.previous_button.disabled = False
